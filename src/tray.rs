...
fn get_default_app_indicator() -> Option<AppIndicator> {
    ...
    let mut appindicator = AppIndicator::new("ReachDesk", icon_path.to_str().unwrap_or("rustdesk"));
    appindicator.set_label("ReachDesk", "A remote control software.");
