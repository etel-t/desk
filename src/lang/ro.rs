...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua ReachDesk..."),
        ...
        ("install_tip", "Din cauza restricțiilor UAC, e posibil ca ReachDesk să nu funcționeze corespunzător. Pentru a evita acest lucru, fă clic pe butonul de mai jos pentru a instala ReachDesk."),
        ...
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți ReachDesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți ReachDesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți ReachDesk să utilize serviciul Accesibilitate."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, caută și deschide [Aplicații instalate] și activează serviciul [ReachDesk Input]."),
        ...
        ("Language", "Limbă"),
        ("Keep RustDesk background service", "Rulează serviciul ReachDesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației ReachDesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show RustDesk", "Afișează ReachDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
