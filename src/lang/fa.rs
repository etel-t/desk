...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "لطفا برنامه را نصب کنید UAC و جلوگیری از خطای ReachDesk برای راحتی در استفاده از نرم افزار"),
        ("Click to upgrade", "برای ارتقا کلیک کنید"),
        ("Click to download", "برای دانلود کلیک کنید"),
        ("Click to update", "برای به روز رسانی کلیک کنید"),
        ("Configure", "تنظیم"),
        ("config_acc", "بدهید \"access\" مجوز ReachDesk برای کنترل از راه دور دسکتاپ باید به"),
        ("config_screen", "بدهید \"screenshot\" مجوز ReachDesk برای کنترل از راه دور دسکتاپ باید به"),
        ...
        ("android_input_permission_tip1", "برای اینکه یک دستگاه راه دور بتواند دستگاه Android شما را از طریق ماوس یا لمسی کنترل کند، باید به ReachDesk اجازه دهید از ویژگی \"Accessibility\" استفاده کند."),
        ("android_input_permission_tip2", "به صفحه تنظیمات سیستم زیر بروید، \"Installed Services\" را پیدا کرده و وارد کنید، سرویس \"ReachDesk Input\" را فعال کنید"),
        ...
        ("Language", "زبان"),
        ("Keep RustDesk background service", "را در پس زمینه نگه دارید ReachDesk سرویس"),
        ...
        ("config_input", "برای کنترل دسکتاپ از راه دور با صفحه کلید، باید مجوز ReachDesk \"Input Monitoring\" را بدهید."),
        ...
        ("still_click_uac_tip", "همچنان کاربر از راه دور نیاز دارد که روی OK در پنجره UAC اجرای ReachDesk کلیک کند."),
