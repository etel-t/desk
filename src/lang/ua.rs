...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі ReachDesk..."),
        ...
        ("install_tip", "У деяких випадках через UAC ReachDesk може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче, щоб встановити ReachDesk у системі"),
        ...
        ("config_acc", "Щоб віддалено керувати своєю стільницею, ви повинні надати ReachDesk права \"доступності\""),
        ("config_screen", "Для віддаленого доступу до стільниці ви повинні надати ReachDesk права для \"запису екрану\""),
        ...
        ("android_input_permission_tip1", "Щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або торкання, вам необхідно дозволити ReachDesk використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [ReachDesk Input]."),
        ...
        ("Language", "Мова"),
        ("Keep RustDesk background service", "Зберегти фонову службу ReachDesk"),
        ...
        ("Show RustDesk", "Показати ReachDesk"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
