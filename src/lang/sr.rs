...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na ReachDesk mrežu..."),
        ...
        ("install_tip", "Zbog UAC ReachDesk ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate ReachDesk na sistem."),
        ...
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, ReachDesk-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, ReachDesk-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite ReachDesk-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [ReachDesk Input] servis."),
        ...
        ("Language", "Jezik"),
        ("Keep RustDesk background service", "Zadrži ReachDesk kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje ReachDesk aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ...
        ("Show RustDesk", "Prikazi ReachDesk"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
