...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 ReachDesk 网络..."),
        ("Enable Service", "允许服务"),
        ("Start Service", "启动服务"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于UAC限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 ReachDesk 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 ReachDesk \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 ReachDesk \"屏幕录制\" 权限。"),
        ("Installing ...", "安装 ..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允許ReachDesk使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [ReachDesk Input] 服务开启。"),
        ...
        ("Language", "语言"),
        ("Keep RustDesk background service", "保持 ReachDesk 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 ReachDesk 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 ReachDesk \"输入监控\" 权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用戶在運行ReachDesk的UAC窗口點擊確認。"),
