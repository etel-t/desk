...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the ReachDesk network..."),
        ...
        ("install_tip", "Due to UAC, ReachDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install ReachDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant ReachDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant ReachDesk \"Screen Recording\" permissions."),
        ...
        ("setup_server_tip", "Welcome to ReachDesk"),
        ("Failed to connect to rendezvous server", "Failed to connect to ReachDesk server"),
        ("Failed to connect to relay server", "Failed to connect to ReachDesk server"),
        ("Failed to connect via rendezvous server", "Failed to connect to ReachDesk server"),
        ("Failed to connect via relay server", "Failed to connect to ReachDesk server"),
        ("Auto Login", "Auto Login (Only valid if you set \"Lock after session end\")"),
        ("whitelist_tip", "Only whitelisted IP can access me"),
        ("Set_email_address_info", "Enter your email to get OTP to access this PC"),
        ("Set_login_info", "Enter your Login info to get a licence key"),
        ("Set Email Address", "Set Email Address"),
        ("Set Login","Set Login"),
        ("Email ID", "Email ID"),
        ("ok", "login received"),
        ("Tags", "Address Book"),
        ("Email missed", "Email missed"),
        ("Invalid Email Please enter a valid email address.", "Invalid Email Please enter a valid email address."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow ReachDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [ReachDesk Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next ReachDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant ReachDesk \"Input Monitoring\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running ReachDesk.")
        ].iter().cloned().collect();
}
