...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till ReachDesk..."),
        ...
        ("install_tip", "På grund av UAC, kan inte ReachDesk fungera ordentligt på klientsidan. För att undvika UAC, tryck på knappen nedan för att installera ReachDesk på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge ReachDesk \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge ReachDesk \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [ReachDesk Input] tjänsten."),
        ...
        ("Language", "Språk"),
        ("Keep RustDesk background service", "Behåll ReachDesk i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa ReachDesk programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
