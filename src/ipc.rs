        ...
        Data::Config((name, value)) => match value {
            None => {
                ...
                if name == "id" {
                    ...
                    value = Some(Config::get_login_id());
                } else if name == "email_id" {
                    value = Some(Config::get_email_id());
                } else if name == "login_password" {
                    value = Some(Config::get_login_password());
                } else if name == "key_license" {
                    value = Some(Config::get_license_key());
                } else if name == "expiry_date" {
                    value = Some(Config::get_expiry_date());
                } else if name == "salt" {
            ...
            Some(value) => {
                if name == "id" {
                    ...
                    Config::set_login_id(&value);
                } else if name == "email_id" {
                    Config::set_email_id(&value);
                } else if name == "expiry_date" {
                    Config::set_expiry_date(&value);
                } else if name == "login_password" {
                    Config::set_login_password(&value);
                } else if name == "key_license" {
                    Config::set_license_key(&value);
                } else if name == "salt" {
...
pub fn set_login_id(v: String)  -> ResultType<()>  {
    Config::set_login_id(&v);
    set_config("login_id", v)
}

pub fn get_login_id() -> String {
    if let Ok(Some(v)) = get_config("login_id") {
        Config::set_login_id(&v);
        v
    } else {
        Config::get_login_id()
...
pub fn set_email_id(v: String)  -> ResultType<()>  {
    Config::set_email_id(&v);
    set_config("email_id", v)
}

pub fn get_email_id() -> String {
    if let Ok(Some(v)) = get_config("email_id") {
        Config::set_email_id(&v);
        v
    } else {
        Config::get_email_id()
...
pub fn set_expiry_date(v: String)  -> ResultType<()>  {
    Config::set_expiry_date(&v);
    set_config("expiry_date", v)
}

pub fn get_expiry_date() -> String {
    if let Ok(Some(v)) = get_config("expiry_date") {
        Config::set_expiry_date(&v);
        v
    } else {
        Config::get_expiry_date()
    } 
}

pub fn set_login_password(v: String)  -> ResultType<()> {
    Config::set_login_password(&v);
    set_config("login_password", v)
}

pub fn get_login_password() -> String {
    if let Ok(Some(v)) = get_config("login_password") {
        Config::set_login_password(&v);
        v
    } else {
...
pub fn get_license_key() -> String {
    if let Ok(Some(v)) = get_config("key_license") {
        Config::set_license_key(&v);
        v
    } else {
        Config::get_license_key()
    }
}

pub fn set_license_key(v: String) -> ResultType<()> {
    Config::set_license_key(&v);
    set_config("key_license", v)
}
