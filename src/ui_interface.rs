...
#[inline]
pub fn set_login_id(login_id: String) {
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
    allow_err!(ipc::set_login_id(login_id));
}

#[inline]
pub fn get_login_id() -> String {
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
    return ipc::get_login_id();
}

#[inline]
pub fn set_email_id(email_id: String) {
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
    allow_err!(ipc::set_email_id(email_id));
}

#[inline]
pub fn get_expiry_date() -> String {
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
    return ipc::get_expiry_date();
}

#[inline]
pub fn set_expiry_date(expiry_date: String) {
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
    allow_err!(ipc::set_expiry_date(expiry_date));
}

#[inline]
pub fn get_email_id() -> String {
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
    return ipc::get_email_id();
}

#[inline]
pub fn set_login_password(login_password: String) {
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
    allow_err!(ipc::set_login_password(login_password));
}

#[inline]
pub fn get_login_password() -> String {
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
    return ipc::get_login_password();
}

#[inline]
pub fn set_license_key(key_license: String) {
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
    allow_err!(ipc::set_license_key(key_license));
}

#[inline]
pub fn get_license_key() -> String {
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
    return ipc::get_license_key();
}
