...
class _CmControlPanel extends StatelessWidget {
  ...
  final url = Uri.parse('http://185.69.211.251:5000/getdata'); // Replace with your URL

  final jsonMap = {'key1': 'value1', 'key2': 'value2'}; // Replace with your JSON data
  final jsonBody = json.encode(jsonMap);
